...
import com.dr.DTO.impl.MessageDTO;
...
public class ExceptionHandlerController extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(NoSuchSponsorException.class)
    ...
    @ExceptionHandler(NoSuchBasketballClubException.class)
    ...
    @ExceptionHandler(ExistsBasketballClubsForPlayerException.class)
    ...
    @ExceptionHandler(ExistsBasketballClubForProjectException.class)
    ...
    @ExceptionHandler(ExistsSponsorForBasketballClubException.class)
    ...
    @ExceptionHandler(AlreadyExistsBasketballClubInSponsorException.class)
    ...
    @ExceptionHandler(BasketballClubAbsentException.class)
    ...
    @ExceptionHandler(SponsorHasNotBasketballClubException.class)
